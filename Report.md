...
#### В результате тестирования был проведен 39 тест, из которых 84.6% прошли успешно, а 15.4% упали. В процентном соотношении успешных/не успешных тестов по кейсам:
